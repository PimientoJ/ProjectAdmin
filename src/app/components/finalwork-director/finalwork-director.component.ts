...
@Component({
  selector: 'app-finalwork-director',
  templateUrl: './finalwork-director.component.html',
  styleUrl: './finalwork-director.component.css'
})
export class FinalworkDirectorComponent {
  value?: string;
