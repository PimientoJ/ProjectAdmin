...
@Component({
  selector: 'app-preliminay-project-director',
  templateUrl: './preliminay-project-director.component.html',
  styleUrl: './preliminay-project-director.component.css'
})
export class PreliminayProjectDirectorComponent {
  value?: string;
